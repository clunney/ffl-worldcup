...
function WildcardPage({groupPicks,wildcardPicks,setWildcardPicks,wildcardRanking,setWildcardRanking,locked,onNext,onBack,results}){
  ...
  return(
    <div style={{paddingBottom:90}}>
      <div style={{padding:"14px 14px 10px",background:C.bg,position:"sticky",top:58,zIndex:9,borderBottom:"1px solid "+C.borderAccent}}>
        <SecHead label="WILDCARD PICKS" sub="Pick 8 third-place teams to advance as wildcards. +1 pt per correct pick. Same point as group advance — doesn’t stack. Max +1 per team for advancing."/>
        {!hasActual&&(
...
function FaqCard(){
  ...
  const faqs=[
    {q:"How does group stage scoring work?",a:(
      <div style={{...T,fontSize:12,color:"#64748b",lineHeight:1.7}}>
        ...
        <div style={{background:"rgba(6,182,212,.08)",border:"1px solid rgba(6,182,212,.2)",borderRadius:8,padding:"8px 10px"}}>
          ...
          <div style={{marginTop:8,fontSize:11,color:"#94a3b8"}}><strong style={{color:"#f1f5f9"}}>Perfect group:</strong> All 4 finish in exact order — +1+1 (1st) + +1+1 (2nd) + +4 bonus = <strong style={{color:"#06b6d4"}}>8 pts</strong>. All 4 must be exact for the bonus.</div>
        </div>
      </div>
    )},
    {q:"How does knockout scoring work?",a:(
      <div style={{...T,fontSize:12,color:"#64748b",lineHeight:1.7}}>
        <p style={{marginBottom:8}}>You earn points if your picked team <strong style={{color:"#f1f5f9"}}>wins that round</strong> — the opponent doesn’t matter. Your bracket is built from your own group picks so matchups may differ from real life. If the team wins their round, you score.</p>
    ...
    {q:"What are wildcards and how are they scored?",a:(
      <div style={{...T,fontSize:12,color:"#64748b",lineHeight:1.7}}>
        <p style={{marginBottom:8}}>After the group stage the <strong style={{color:"#f1f5f9"}}>best 8 of 12 third-place teams</strong> advance as wildcards. You pick which 8 — <strong style={{color:"#06b6d4"}}>+1 pt for each team that advances</strong> by any route. If your wildcard pick finishes 1st or 2nd instead, you still score. If your 1st/2nd group pick ends up advancing as a wildcard, you get +1 via your wildcard selection.</p>
